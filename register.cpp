...
void Register::initializeRegisters()
{
	...
	sparcRegisters.registerWindows = REGISTER_WINDOWS;       // Get number of register windows from configuration file
	...
	sparcRegisters.registerSet = (unsigned long*)malloc(sizeof(unsigned long)*512);

//	sparcRegisters.registerSet = new unsigned long*[REGISTER_WINDOW_WIDTH * REGISTER_WINDOWS * SIZEOF_INTEGER_REGISTER];
	...
	sparcRegisters.globalRegisters = (unsigned long*)malloc(sizeof(unsigned long)*32);

//	sparcRegisters.globalRegisters = new unsigned long*[SIZEOF_INTEGER_REGISTER * GLOBAL_REGISTERS];
